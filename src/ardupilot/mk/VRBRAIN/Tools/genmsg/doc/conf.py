...
intersphinx_mapping = {
    'genmsg': ('http://ros.sorg/doc/api/genmsg/html', None),
    'vcstools': ('http://ros.sorg/doc/api/vcstools/html', None),
    'rosinstall': ('http://ros.sorg/doc/api/rosinstall/html', None),
    'rospkg': ('http://ros.sorg/doc/api/rosinstall/html', None),
    'rosdep2': ('http://ros.sorg/doc/api/rosdep2/html', None),
    }

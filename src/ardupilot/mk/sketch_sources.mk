...
SKETCHOBJS := $(addsuffix .so,$(basename $(SKETCHOBJS)))
...
SKETCHLIBOBJS		:=	$(addsuffix .so,$(basename $(subst $(SKETCHBOOK),$(BUILDROOT),$(SKETCHLIBSRCS))))
...
$(BUILDROOT)/make.flags: FORCE
	...
	@cmp $(BUILDROOT)/make.flags $(BUILDROOT)/make.flags.new > /dev/null 2>&1 || rm -f $(SRCROOT)/*.so
